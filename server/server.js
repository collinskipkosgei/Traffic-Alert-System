...
// ========== RATE LIMITING ==========
// Global limiter - all API endpoints (high-frequency location pings are excluded)
const globalLimiter = rateLimit({
  ...
  skip: (req) => {
    ...
    return (
      path.startsWith('/api/location/heartbeat') ||
      path.startsWith('/api/location/update') ||
      path.startsWith('/api/location/offline') ||
